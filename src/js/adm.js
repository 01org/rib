 ...
 * name, or type, or value. Result need to meet all key-value pairs in filter
 ...
 * any type, if the it is a function or regular expression, it will be treated
 * as check rule funtion to determine if the value matchs or not, for case of
 * rule function, property value will be passed as parameter.
 *
