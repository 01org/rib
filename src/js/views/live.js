            ...
            addDeviceButton = $('<a/>')
                ...
                .click( function () {
                    $("<form/>")
                        ...
                        .append('<input name="screenWidth" type="number" max="10000"  style="width:5em" required size="4"/>')
                        .append('<span>x</span>')
                        .append('<input name="screenHeight" type="number" max="10000" style="width:5em" required size="4"/>')
                        .append('<br/><br/>')
